...
export const ONBOARDING_QUIZ_QUESTIONS = [
  {
    ...
    options: [
      { id: "q1_opt_team_event", label: "Joining a team challenge", weights: { "Sports & Fitness": 3, "Social & Community": 1 } },
      { id: "q1_opt_creative", label: "Creating art or music", weights: { "Arts & Culture": 3 } },
      { id: "q1_opt_building", label: "Building or coding a project", weights: { "STEM & Technology": 3, "Social & Community": 1 } },
  ...
  },
  {
    ...
    options: [
      { id: "q2_opt_leadership", label: "Leadership and networking", weights: { "Social & Community": 4, "STEM & Technology": 1 } },
      ...
      { id: "q2_opt_tech", label: "Technical growth", weights: { "STEM & Technology": 4 } },
    ],
  },
  {
    id: "q_event_type",
    ...
    options: [
      { id: "q3_opt_workshop", label: "Workshop or seminar", weights: { "STEM & Technology": 2, "Social & Community": 2 } },
      ...
      { id: "q3_opt_community", label: "Volunteer or community meet", weights: { "Social & Community": 3 } },
    ],
  },
  {
    id: "q_free_time",
    ...
    options: [
      { id: "q4_opt_side_projects", label: "Side projects and tinkering", weights: { "STEM & Technology": 2, "Hobbies & Lifestyle": 1 } },
      { id: "q4_opt_clubs", label: "Clubs and campus socials", weights: { "Social & Community": 2, "Hobbies & Lifestyle": 1 } },
