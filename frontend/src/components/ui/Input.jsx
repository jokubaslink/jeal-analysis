  ...
  return (
    <input
      ...
      className={cn(
        ...
        "outline-none transition-[box-shadow,border-color] duration-[var(--duration-fast)]",
        "focus-visible:border-[var(--color-brand-green)] focus-visible:ring-2 focus-visible:ring-[var(--color-brand-green)] focus-visible:ring-offset-2",
